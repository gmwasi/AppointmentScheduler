...
namespace AppointmentScheduler.Persistence.Migrations
{
    public partial class InitialSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Persons",
                columns: new[] { "Id", "DateOfBirth", "FacilityId", "FirstName", "GenderId", "HudumaNamba", "LastName", "MaritalStatusId", "MiddleName" },
                values: new object[,]
                {
                    { 2, new DateTime(1990, 12, 11, 0, 0, 0, 0, DateTimeKind.Local), 1, "User", 2, "12345672", "Jil", 3, "2" },
                    { 1, new DateTime(1995, 12, 11, 0, 0, 0, 0, DateTimeKind.Local), 1, "User", 1, "12345671", "Doe", 3, "1" }
                });

            migrationBuilder.InsertData(
                table: "Persons",
                columns: new[] { "Id", "DateOfBirth", "FacilityId", "FirstName", "GenderId", "HudumaNamba", "LastName", "MaritalStatusId", "MiddleName" },
                values: new object[] { 3, new DateTime(1980, 12, 11, 0, 0, 0, 0, DateTimeKind.Local), 1, "User", 1, "12345673", "Don", 4, "3" });
